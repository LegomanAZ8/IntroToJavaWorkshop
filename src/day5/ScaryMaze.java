...
int BackgroundColor = (-663015);
		//6. if the mouse falls off the path (if it is on the background)
		if(BackgroundColor == mouseColor){
		scare();
        if(13815084 == mouseColor)
		JOptionPane.showMessageDialog(null, "you gat gud");
		}
...
showScaryImage("timthumb.jpeg");
	...
	@Override
	public void run() {
		JFrame frame = new JFrame("TRACER BUTT MAZE");
		frame.add(this);
